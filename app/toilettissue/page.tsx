    ...
    return (
        ...
        <div className="bg-gray-100 py-10">
            ...
            <div className="container mx-auto px-4">
                <h1 className="text-4xl font-bold text-center text-gray-800 mb-10">Toilet Tissue Papers Products</h1>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Product 1 */}
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            <Image src="/img1-removebg-preview.png" width={500} height={500} alt="Product Image" className="rounded-lg" />
