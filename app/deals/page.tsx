    ...
    return(
        <div>
            ...
            <div className="container mx-auto px-4">
                <h1 className="text-4xl font-bold text-center text-gray-800 mb-10">Top-Deals For You</h1>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-600">Buy one Get one Free</h3>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            <Image src="/img7.jpg" width={500} height={500} alt="Product Image" className="rounded-lg" />
                            <h3 className="text-lg font-semibold text-gray-600">Buy two Get one Free</h3>
                        ...
                        <div className="grid grid-cols-2 gap-6 items-center py-6">
                        <h1 className="text-2xl font-bold text-gray-900">$7.59</h1>
                            <Button className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">
                                Add to Cart
                            </Button>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            <Image src="/img6.jpeg" width={300} height={300} alt="Product Image" className="rounded-lg" />
                            <h3 className="text-lg font-semibold text-gray-600">Buy 10 Get 5 Free</h3>
                        ...
                        <div className="grid grid-cols-2 gap-6 items-center py-6">
                        <h1 className="text-2xl font-bold text-gray-900">$12.69</h1>
                            <Button className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">
                                Add to Cart
                            </Button>
                        </div>
