    ...
    return (
        <div className="bg-gray-100 py-10">
            <div className="container mx-auto px-4">
                <h1 className="text-4xl font-bold text-center text-gray-800 mb-10">Top-Selling Products</h1>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-600">#1 Best Seller</h3>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-600">#2 Best Seller</h3>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-600">#3 Best Seller</h3>
