                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            <Image src="/img12.webp" width={500} height={500} alt="Product Image" className="rounded-lg" />
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:scale-105 transition-all">
                        <div className="grid grid-cols-1 gap-4">
                            <Image src="/img14.jpeg" width={300} height={300} alt="Product Image" className="rounded-lg" />
                            <h3 className="text-lg font-semibold text-gray-600"></h3>
